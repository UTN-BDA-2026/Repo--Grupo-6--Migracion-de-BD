...
Objetivo: Migrar y gestionar información de usuarios (correo, nombre, fecha, etc) que se registran o inician sesión en un prototipo, los datos se alojan inicialmente en SQLite y un usuario con rol de Administrador debe migrar esos datos a otra base de datos, por ejemplo PostgreSQL, manteniendo integridad de los datos y seguridad de la información.
